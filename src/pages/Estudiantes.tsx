...
// // 1. Actualizamos las Props para incluir la institución seleccionada
// type Props = {
//   userRole: "admin" | "auxiliar";
//   institucion: { id: number; nombre: string; nit: string } | null;
// };

// const Estudiantes: React.FC<Props> = ({ userRole, institucion }) => {
//   const navigate = useNavigate();
//   const location = useLocation();
//   const [students] = useState<any[]>([]);
...
//         <div className="sidebar-header">
//           <h2>Sistema Educativo</h2>
//           {/* Muestra el nombre de la institución si existe */}
//           <span className="inst-badge">
//             {institucion ? `📍 ${institucion.nombre}` : "Sin institución"}
//           </span>
//           <span className="role-badge">
//             {userRole === "admin" ? "Gestión Administrativa" : "Gestión Auxiliar"}
//           </span>
//         </div>
...
//         <div className="sidebar-footer">
//           {/* Botón opcional para cambiar de institución reiniciando el estado */}
//           <button className="btn-change-inst" onClick={() => window.location.reload()}>
//             🔄 Cambiar Colegio
//           </button>
//           <button className="sidebar-logout" onClick={() => navigate("/home")}>
//             🚪 Cerrar Sesión
...
//           <p>
//             {userRole === "admin" 
//               ? `Carga masiva para ${institucion?.nombre || "la institución"}` 
//               : "Portal de carga de archivos de alumnos"}
//           </p>
//         </header>
...
//                 <tr>
//                   <td colSpan={5} className="empty-table-msg">
//                     No hay datos cargados en {institucion?.nombre || "el sistema"}.
//                   </td>
//                 </tr>
//               )}
//             </tbody>
