...
//   // Detectamos el rol desde la URL (?role=auxiliar o ?role=admin)
//   const queryParams = new URLSearchParams(location.search);
//   const role = queryParams.get("role") || "admin"; // Por defecto admin
...
//     // MODO DESARROLLO: Redirección basada en el rol detectado
//     setIsAuth(true);
    
//     if (role === "auxiliar") {
//       navigate("/estudiantes"); // El auxiliar entra directo a estudiantes
//     } else {
//       navigate("/dashboard");   // El admin entra al dashboard
//     }
//   };

//   // Personalización visual según el rol
//   const isAuxiliar = role === "auxiliar";

//   return (
//     <div className={`login-container ${isAuxiliar ? "theme-auxiliar" : ""}`}>
//       <div className="login-box">
//         {/* El título cambia según el botón presionado en el Home */}
